...
- [x] 1. Status truth + rescue spec gate
...
- [x] 2. Add DESIGN.md as enforceable visual contract
...
- [x] 3. Fix deterministic testMode and stable timing contract
...
- [x] 4. Replace weak QA with narrative, role, difficulty, and screenshot gates
...
- [x] 5. Rebuild Canvas visual/narrative vertical slice within one room
...
- [x] 6. Deepen single-button gameplay with authored beats, not new mechanics
...
- [x] 7. Polish audio, HUD, and feedback without expanding scope
...
- [x] 8. Clean PWA identity and public-facing metadata
...
- [x] 9. External playtest gate and bounded iteration
...
- [x] 10. Final quality certification, red-line scan, and release-status update
